...
Wowlo is a tuition-management web app for a Singapore tutor (homework, messages, tuition fees, exam papers, MCQ quizzes; student/parent + tutor/admin roles). Built in vertical slices per `Wowlo_v2.1_Refined_Decisions_and_Architecture.md` (authoritative — wins over `Wowlo_Tuition_Management_App_v2.md` on conflicts).
