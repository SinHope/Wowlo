<x-app-layout>
    <x-slot name="header">Edit Banner Notification</x-slot>
    ...
    <div class="mx-auto max-w-2xl">
        ...
        <div class="rounded-2xl border border-gray-100 bg-white p-6 shadow-sm sm:p-8">
            <h2 class="mb-1 text-xl font-extrabold text-ink">Edit banner</h2>
            <p class="mb-6 text-sm text-muted">Saving re-shows this banner to anyone who had already dismissed it.</p>
